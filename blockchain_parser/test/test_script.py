...
class TestScript(unittest.TestCase):
    def test_op_return_script(self):
        case1 = "6a"
        script = Script.from_bytes(a2b_hex(case1))
    ...
    def test_unknown_script(self):
        case = "40"
        script = Script.from_bytes(a2b_hex(case))
    ...
    def test_pubkey_script(self):
        script = Script.from_bytes(a2b_hex("4104678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5fac"))
